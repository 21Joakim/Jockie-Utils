...
public class CommandDecide extends CommandImpl {
	...
	public void onCommand(MessageReceivedEvent event, CommandEvent commandEvent, @Argument(description="statement", acceptQuote=true) String statement, @Argument(description="statement 2", acceptQuote=true) String statement2) {
