...
public class CommandAddAll extends CommandImpl {
	...
	public void onCommand(MessageReceivedEvent event, CommandEvent commandEvent, @Argument(description="decimal number") @Endless(minArguments=2, maxArguments=10) Double[] nums) {
		double sum = 0;
