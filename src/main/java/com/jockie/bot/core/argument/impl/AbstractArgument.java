...
public abstract class AbstractArgument<Type> implements IArgument<Type> {
	...
	public <BuilderType extends IArgument.Builder<Type, ?, ?>> AbstractArgument(BuilderType builder) {
